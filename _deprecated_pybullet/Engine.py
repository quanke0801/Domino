...
class Engine:
	...
	def InitializePhysics(self):
		...
		ground_collision_shape = createCollisionShape(GEOM_PLANE)
		ground_id = createMultiBody(0, ground_collision_shape)
		changeDynamics(ground_id, -1, lateralFriction = 0.5, restitution = 0.1)
		if self.mode == GUI:
			resetDebugVisualizerCamera(3, 0, -40, [0, 0, 0])
		...
		setPhysicsEngineParameter(numSolverIterations = 20)
